...
document.querySelectorAll<HTMLButtonElement>('#transaction-multiplier button[data-increment]').forEach(el => {
...
const lock_account = document.querySelector<HTMLInputElement>('#lock-account')
